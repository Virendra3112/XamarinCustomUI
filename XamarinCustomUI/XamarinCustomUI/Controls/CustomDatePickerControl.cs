...
{
    public class CustomDatePickerControl : DatePicker
    {
        
        //public static readonly BindableProperty ImageProperty =
        //    BindableProperty.Create(nameof(Image), typeof(string), typeof(CustomDatePicker), string.Empty, BindingMode.TwoWay);
        ...
        public static readonly BindableProperty PlaceHolderProperty =
            BindableProperty.Create(nameof(PlaceHolder), typeof(string), typeof(CustomDatePickerControl), "");
        ...
        BindableProperty.Create(nameof(NullableDate), typeof(DateTime?), typeof(CustomDatePickerControl), null, defaultBindingMode: BindingMode.TwoWay);
